...
@foreach($months as $month)
    <div class="row">
        <div class="@if(count($meses)>1) col-md-5 @else col-md-3 @endif">
            <?php $nombre_input="mes_".(int)$month."_".$year;?>
            <div class="form-group">
                <label for="">Usuarios activos en <span class="nombre_mes">{{$n_meses[(int)$month]}}</span> {{$year}} <span class="required">*</span></label>
