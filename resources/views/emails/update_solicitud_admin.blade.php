                        ...
                        <table align="center" cellpadding="0" border="0" cellspacing="0" style="max-width: 400px; width: 100%">
                            <tr>
                                <td style="padding-bottom: 20px;">
                                    <div class="cuerpo-mail">El usuario <b>{{$data['usuario']}} ({{$data['usuario_email']}})</b> ha actualizado los datos de su solicitud para la convocatoria "{{ $data['convocatoria_nombre'] }}"</div>
                                </td>
                            </tr>
                            <tr>
                                <td style="">
                                    <div class="cuerpo-mail">Para ver esta solicitud usa este enlace: <a href="{{ action('AdminSolicitudes@Edit', $data['_key']) }}">{{ action('AdminSolicitudes@Edit',$data['_key']) }}</a></div>
                                </td>
                            </tr>
                        </table>
                    </td>
