                        ...
                        <table align="center" cellpadding="0" border="0" cellspacing="0" style="max-width: 400px; width: 100%">
                            <tr>
                                <td style="padding-bottom: 20px;">
                                    <div class="cuerpo-mail">El usuario <b>{{$data['usuario']}} ({{$data['usuario_email']}})</b> ha hecho una solicitud.</div>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding-bottom: 20px;">
                                    <div class="cuerpo-mail"><b>Convocatoria: </b> {{ $data['convocatoria_nombre'] }}</div>
                                    <div class="cuerpo-mail"><b>Fecha solicitud: </b> {{\Illuminate\Support\Carbon::createFromTimestamp($data['fecha_registro'])->formatLocalized('%d %B %Y')}}<br/></div>
                                </td>
                            </tr>
                            <tr>
                                <td style="">
