                        ...
                        <table align="center" cellpadding="0" border="0" cellspacing="0" style="max-width: 400px; width: 100%">
                            <tr>
                                <td style="padding-bottom: 20px;">
                                    <div class="cuerpo-mail">¡Hola <span style="color: #4337FF;">{{$data['nombre']}}</span>!</div>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding-bottom: 20px;">
                                    <div class="cuerpo-mail">Hemos recibido tu petición para recuperar tu contraseña, para continuar usa el siguiente botón:</div>
                                </td>
                            </tr>
                            <tr>
                                <td align="center" style="padding-top: 11px;padding-bottom: 10px;">
                                    <table>
                                        <tr>
                                            <td align="center" style="-webkit-border-radius: 50px; -moz-border-radius: 50px; border-radius: 50px;" bgcolor="#1D2B36"><a href="{{action('HomeController@PasswordRecoveryEmail',$data['password_recover'])}}" target="_blank" style="font-size: 14px; font-family: Helvetica, Arial, sans-serif; color: #fff; text-decoration: none; text-decoration: none; -webkit-border-radius: 50px; -moz-border-radius: 50px; border-radius: 50px; padding: 12px 34px; border: 1px solid #1D2B36; display: inline-block;"><b>Recuperar Contraseña</b></a></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td style="padding-bottom:20px;padding-top:20px;">
                                    <div class="x_cuerpo-mail" style="font-size:12px;line-height:1.3em;">Si no pediste recuperar tu contraseña ignora este correo electrónico y notifícanos.</div>
                                </td>
                            </tr>
                        </table>
                    </td>
