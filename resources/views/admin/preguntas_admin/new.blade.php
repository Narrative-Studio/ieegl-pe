...
@section('titulo') Nueva Pregunta @endsection
@section('seccion') Preguntas @endsection
@section('accion') Nueva @endsection
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                {!! Form::open(['action' => ['AdminPreguntas@Save'], 'method'=>'POST', 'class'=>'form form-horizontal', 'files' => false]) !!}
                                <div class="form-body">
