                ...
                <div class="row">
                    <div class="col-10 pr-0">
                        ...
                        <fieldset class="form-group form-group-style hidden m-0">
                            <input type="text" class="form-control" value="{{$titulo}}" data-dato="cuenta" data-name="nombre" id="input_{{$campo}}"/>
                            <input type="text" class="form-control m-0 campo_descripcion" value="" data-dato="cuenta" data-name="desc" style="margin-top: 10px;" placeholder="Descripción del campo" id="input_{{$campo}}"/>
                        </fieldset>
                    ...
                    <div class="col-2 text-right pl-0">
                        <div class="d-inline-block custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input bg-success" id="check_{{$campo}}" value="cuenta_{{$campo}}">
