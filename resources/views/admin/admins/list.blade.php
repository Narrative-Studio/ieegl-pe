...
@section('titulo') Listado de Administradores @endsection
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body card-dashboard">
                                <!--{!! Form::open(['action'=>'AdminAdministradores@Index', 'method'=>'GET', 'class'=>'navbar-form navbar-left', 'role'=>'search']) !!}
                                <div class="row">
                                    <div class="col-sm-10">
                                    ...
                                    <div class="row">
                                        <div class="col-12 text-right">
                                            <a href="{{ action('AdminAdministradores@New') }}" class="btn btn-success mr-1 pull-right"><i class="fas fa-edit"></i> Crear Nuevo</a>
                                        </div>
                                    </div>
                            </div>
                            @if(count($datos)>0)
                                        ...
                                        @foreach($datos as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#" onclick="delete_row('item-{{$item->_key}}', '{{ action('AdminAdministradores@Delete',$item->_key) }}')" class="btn btn-sm  btn-danger mr-1"><i class="fas fa-trash"></i> Borrar</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
