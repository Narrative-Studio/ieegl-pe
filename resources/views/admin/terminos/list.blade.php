...
@section('titulo') Listado de Terminos @endsection
                            ...
                            <div class="card-body card-dashboard">
                                <div class="row">
                                    <div class="col-12 text-right">
                                        <a href="{{ action('AdminTerminos@New') }}" class="btn btn-success mr-1 pull-right"><i class="fas fa-edit"></i> Crear Nuevo</a>
                                    </div>
                                </div>
                                <!--{!! Form::open(['action'=>'AdminTerminos@Index', 'method'=>'GET', 'class'=>'navbar-form navbar-left', 'role'=>'search']) !!}
                                <div class="row">
                                    <div class="col-sm-10">
                                    ...
                                    <table class="table mb-0">
                                        ...
                                        @foreach($datos as $item)
                                            <tr>
                                                <td>{{$item->nombre}}</td>
                                                <td>
                                                    <a href="{{ action('AdminTerminos@Edit',$item->_key) }}" class="btn btn-sm btn-info mr-1"><i class="fas fa-edit"></i> Editar</a>
                                                    <a href="#" onclick="delete_row('item-{{$item->_key}}', '{{ action('AdminTerminos@Delete',$item->_key) }}')" class="btn btn-sm  btn-danger mr-1"><i class="fas fa-trash"></i> Borrar</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
