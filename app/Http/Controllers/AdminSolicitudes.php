    ...
    public function Edit($id){
        ...
        if( $solicitud->convocatoria->quien!='6375236') {
            ...
            return view('admin.solicitudes.edit',
                compact('solicitud', 'item', 'socios', 'industrias', 'etapas', 'paises', 'nivel_tlr', 'montos', 'modelos_ventas', 'meses', 'n_meses', 'meses_usuarios', 'n_meses_usuarios', 'montos_usuarios', 'meses_inversion', 'vehiculos', 'terminos', 'meses_clientes', 'n_meses_clientes', 'montos_clientes')
            );
        }else{
            return view('admin.solicitudes.edit',
                compact('solicitud')
