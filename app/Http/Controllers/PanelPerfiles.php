...
class PanelPerfiles extends Controller
{
    ...
    public function Estudios(){
        ...
        return view('panel.'.$this->collection.'.estudios', compact('item','universidades'));
    }
