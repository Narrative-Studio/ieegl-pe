...
class Controller extends BaseController
{
    ...
    public $sexo = [
        'Femenino'=>'Femenino',
        'Masculino'=>'Masculino',
        'No deseo especificar'=>'No deseo especifica'
    ];
    public $a_que_te_dedicas = [
        'Empleado'=>'Empleado',
        'Empleado con negocio propio'=>'Empleado con negocio propio',
        'Estudiante'=>'Estudiante',
        'Estudiante con negocio propio'=>'Estudiante con negocio propio',
        'Profesor'=>'Profesor',
    ...
    public $estudiando = [
        ...
        'Sí en otra universidad'=>array(
        'Técnico en otra universidad'=>'Técnico',
        'Preparatoria en otra universidad'=>'Preparatoria',
        'Licenciatura en otra universidad'=>'Licenciatura',
        'Posgrado en otra universidad'=>'Posgrado'
        )
    ];
